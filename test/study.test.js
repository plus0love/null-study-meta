...
test('소켓 E2E: 입장 ack 프로필/저장소, 목표 브로드캐스트, 세션 저장 → leaderboard:refresh·출석·목표 달성, 할 일 CRUD', async (t) => {
  ...
  assert.deepEqual(ja.profile, { goal: null, streak: { streak: 0, weekDays: 0, attendedToday: false }, coins: 0, rewards: [], coinProgress: { carrySeconds: 0, nextCoinAt: null, studying: false }, vehicleConfig: { active: null, decal: null, horn: null }, statsPublic: false });
